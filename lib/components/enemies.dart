...
with HasGameReference<PixelAdventure>, CollisionCallbacks{
  ...
  int amtIdle = 13;
  int amtRun = 14;
  Vector2 hitBoxSize = Vector2(24, 26);
  Vector2 hitBoxPosition = Vector2(4, 6);
  ...
  void _loadAllAnimations() {
    _idleAnimation = _CreateaAnimation('Idle', amtIdle);
    _runAnimation = _CreateaAnimation('Run', amtRun); 
  ...
  SpriteAnimation _CreateaAnimation(String animation, int amount){
    return SpriteAnimation.fromFrameData( game.images.fromCache('Enemies/$enemy/$animation (${(textureSize.x).toInt()}x${(textureSize.y).toInt()}).png'), SpriteAnimationData.sequenced(
      amount: amount, 
      stepTime: stepTime, 
