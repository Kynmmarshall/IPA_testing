...
Player({ 
 ...
 SpriteAnimation? idleAnimation, runningAnimation, fallingAnimation, hitAnimation, jumpingAnimation, appearingAnimation, disappearingAnimation;
...
// Loads Assets to the game (inbuilt function that can be modified)
  ...
  void update(double dt) {
    ...
    while(accumulatedTime>=fixedDeltaTime){
      if(!gotHit && !reachedCheckpoint && !game.menu_screen){
    _updatePlayerState();
